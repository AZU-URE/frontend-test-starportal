...
export default function RecomNarrativeCard(el) {
  return (
    <div className="relative space-x-5 rounded-2xl h-fit flex lg:flex-row flex-col items-center justify-center bg-zinc-800/40 cursor-pointer hover:bg-zinc-800/90 border-[1px] border-zinc-700/50 p-[0.5rem] transition-colors duration-300">
