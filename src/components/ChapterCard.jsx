export default function ChapterCard(el) {
  return (
    <div className="relative space-x-5 rounded-2xl h-fit flex lg:flex-row flex-col items-center justify-center bg-zinc-800/40 cursor-pointer hover:bg-zinc-800/90 border-[1px] border-zinc-700/50 p-[0.5rem] transition-colors duration-300 w-[40vw]">
      <div className="flex rounded-xl m-3 p-2 min-w-[10rem] h-[25vh] bg-zinc-800/50 backdrop-blur-sm backdrop-filter border-[1px] border-zinc-400/50 relative">
        ...
        <div className="absolute backdrop-filter backdrop-blur-sm bg-black/20 rounded-full border-[1px] border-zinc-400 p-[0.5rem] px-[1rem] text-white font-semibold bottom-[1rem] left-[25%]">
          {el.quest} Quests
        </div>
      </div>
