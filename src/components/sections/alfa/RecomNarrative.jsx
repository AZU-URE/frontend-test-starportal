...
export default function RecomNarrative() {
  return (
    <section className="w-[100%] px-[11rem] border-t-[1px] border-t-zinc-700/50 ">
      <div className="flex flex-col items-start justify-center space-y-5 mt-[3rem]  w-full">
        ...
        <div className="grid grid-cols-2 gap-10 w-full items-center justify-center text-center">
